...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-rwgw345095809@business.example.com";
    private string APIPassword = "3xB2^6K?";
    private string APISignature = "Wingtip Toys";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44361/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44361/Checkout/CheckoutCancel.aspx";
